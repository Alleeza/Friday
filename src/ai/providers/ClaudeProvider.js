 ...
 *   const provider = new ClaudeProvider({ model: 'claude-opus-4-6', apiUrl: '/api/claude/messages' });
 */
export class ClaudeProvider extends AIProvider {
  /**
   * @param {{ apiUrl?: string, model?: string, maxTokens?: number }} options
   */
  constructor({ apiUrl = '/api/claude/messages', model = 'claude-sonnet-4-6', maxTokens = 1024 } = {}) {
    super();
    this.apiUrl = apiUrl;
    this.model = model;
